      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
            ...
            <form onSubmit={handleUpdatePassword} className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    {showPasswords.new ? <EyeOff size={20} animate={true} loop={true} loopDelay={5000} /> : <Eye size={20} animate={true} loop={true} loopDelay={5000} />}
                  </button>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-white transition"
                  >
                    {showPasswords.confirm ? <EyeOff size={20} animate={true} loop={true} loopDelay={5000} /> : <Eye size={20} animate={true} loop={true} loopDelay={5000} />}
                  </button>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-br from-[#0f0a20] to-[#1a0f3a] border border-red-500/30 rounded-2xl p-8">
            ...
            >
              <LogOut size={20} animate={true} loop={true} loopDelay={5000} />
              Se déconnecter
            </button>
          </div>
        </div>
