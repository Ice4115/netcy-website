    ...
    <section id="contact" className="relative scroll-mt-32">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
        ...
        <div className="space-y-4">
          ...
          {/* LinkedIn card */}
          <div className="flex items-start gap-4 p-5 bg-surface-container-low border border-outline-variant rounded-xl hover:bg-surface-container transition-colors group">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: 'rgba(10,102,194,0.12)', color: '#0a66c2' }}>
            ...
            <div>
              ...
              <a
                ...
                className="text-sm font-medium text-on-surface hover:underline transition-colors"
                target="_blank"
          ...
          {/* GitHub card */}
          <div className="flex items-start gap-4 p-5 bg-surface-container-low border border-outline-variant rounded-xl hover:bg-surface-container transition-colors">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 bg-surface-container border border-outline-variant text-on-surface">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div>
              ...
              <a
                ...
                className="text-sm font-medium text-on-surface-variant hover:text-on-surface hover:underline transition-colors"
                target="_blank"
                rel="noopener noreferrer"
              >
                jean-marie-jung
